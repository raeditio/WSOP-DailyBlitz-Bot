...
if __name__ == "__main__":
    ...
    print("The bot is now running AUTOMATICALLY.")
    ...
    with mss.MSS() as sct:
        ...
        while True:
            ...
            if matches and len(matches) == 9:
                ...
                print("\nHand evaluated! Waiting 3 seconds for the next round...")
                time.sleep(3.0) # Prevents spam-clicking while the game animations play
            else:
                time.sleep(0.5) # Scan twice a second while waiting for the board to appear